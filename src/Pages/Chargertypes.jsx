...
const Chargertypes = () => {
    ...
    const chargers = [
        ...
        },
        {
            ...
            desc: "Rapid charging stations",
            power: "50-150 kW",
            speed: "180-250 mi/hr",
            timeLabel: "80% charge time",
            timeVal: "30-45 min",
            bestFor: "Best for: Long trips, quick top-ups",
            btnLabel: "View Stations",
            isPopular: false
        },
        {
            ...
            desc: "Ultra-fast Tesla network",
            power: "150-250 kW",
            speed: "300+ mi/hr",
            timeLabel: "80% charge time",
            timeVal: "15-25 min",
            bestFor: "Best for: Tesla vehicles, highway travel",
            btnLabel: "View Stations",
            isPopular: false
        }
    ];
